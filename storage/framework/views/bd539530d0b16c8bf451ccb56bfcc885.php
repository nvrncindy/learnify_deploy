                    ...
                    <div class="card-body flex-grow-1 ms-3">
                        ...
                        <p class="card-text mb-1">
                            <small class="text-muted">
                                Enrolled: <?php echo e($course->pivot->created_at?->format('d M Y') ?? 'N/A'); ?>                            </small>
                        </p>
                        <p class="card-text">
                            <small class="text-muted">
                                Updated: <?php echo e($course->updated_at?->diffForHumans() ?? 'N/A'); ?>                            </small>
                        </p>
                    </div>
...
<?php echo $__env->make('layout.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\Users\Rafael Sanyoto\Documents\learnify-main\learnify-main\learnify\resources\views/MyCourse.blade.php ENDPATH**/ ?>